...
\begin{figure*}
\centering 
\subfloat[\label{fig:screen_0_main}Main search screen]{\begin{centering}
\epsfig{file=screen_0_main.eps,height=2.8in}
\par\end{centering}

}\subfloat[\label{fig:screen_5_results}Search results listing]{\begin{centering}
\epsfig{file=screen_5_results.eps,height=2.8in}
\par\end{centering}

}\subfloat[\label{fig:screen_6_singleevent}Details about a single event]{\begin{centering}
\epsfig{file=screen_6_singleevent.eps,height=2.8in}
\par\end{centering}
...
\begin{figure*}
\centering 
\subfloat[\label{fig:screen_1_where}Location related options]{\begin{centering}
\epsfig{file=screen_1_where.eps,height=2.8in}
\par\end{centering}

}\subfloat[\label{fig:screen_2_building}Search \& select building ]{\begin{centering}
\epsfig{file=screen_2_building.eps,height=2.8in}
\par\end{centering}

}\subfloat[\label{fig:screen_4_category}Hierarchical categories]{\begin{centering}
\epsfig{file=screen_4_category.eps,height=2.8in}
\par\end{centering}
